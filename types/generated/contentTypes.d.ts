...
export interface ApiFormBlockFormBlock extends Schema.CollectionType {
...
export interface ApiFormSubmitFormSubmit extends Schema.CollectionType {
  collectionName: 'form_submits';
  info: {
    singularName: 'form-submit';
    pluralName: 'form-submits';
